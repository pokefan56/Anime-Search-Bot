...
class AnimeDex:
    ...
    def search(query):
        url = 'http://StupidBoi.vercel.app/search?query=' + \
        ...
        for anime in soup.find('div', 'divox').find_all('a'):
            ...
            url = 'http://StupidBoi.vercel.app' + anime.get('href')
    ...
    def anime(url):
        ...
        for i in eps:
            ep.append((i.text, 'http://StupidBoi.vercel.app' + i.get('href')))
